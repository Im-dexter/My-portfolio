...
const Welcome = () => {
  ...
  return (
    <section id="welcome">
      <p ref={subtitleRef}>
        {renderText("Hey, I'm Sourabh! Welcome to my", "text-3xl font-georama",100)}</p>
      <h1 ref={titleRef} className="mt-7">
        {renderText("Portfolio", "text-9xl italic font-georama", 700)}</h1>

    <div className="small-screen">
        <p>
            This portfolio is designed for laptops and tablets only.
        </p>
    </div>
    </section>
